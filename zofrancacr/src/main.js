      ...
      <section class="auth-shell">
        ...
        <section class="auth-card">
          <div class="auth-card__topbar">
            <button class="auth-pill auth-pill--active" type="button" data-view-tab="login">Iniciar sesión</button>
            <button class="auth-pill" type="button" data-view-tab="register">Registrarse</button>
          </div>
